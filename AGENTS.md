...
- The Pi/executor must not import `fs`, `dockerode`, or Cloudflare bindings. The worker may import Node and Flue’s Node target (`@flue/runtime/node`). Flue sandbox adapters may import their SDKs.
